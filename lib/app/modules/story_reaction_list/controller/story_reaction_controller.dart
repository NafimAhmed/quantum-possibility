...
import 'package:quantum_possibilities_flutter/app/models/story_reaction_model.dart';
...
class StoryReactionController extends GetxController{
  ...
  Future<void> getStoriesView() async {
    ...
    debugPrint('=================getStoriesView Start===============================================');
    ...
    if (apiResponse.isSuccessful) {
      storytList.value = (((apiResponse.data as Map<String, dynamic>)['results']) as List)

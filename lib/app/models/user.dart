...
class UserModel {
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      //     ? ReligionModel.fromMap(map['religion'] as Map<String, dynamic>)
      //     : null,
      date_of_birth:

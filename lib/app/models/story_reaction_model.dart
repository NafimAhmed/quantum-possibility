...
StoryReactionModel storyReactionModelFromJson(String str) => StoryReactionModel.fromJson(json.decode(str));

String storyReactionModelToJson(StoryReactionModel data) => json.encode(data.toJson());
...
class ViewersList {
  ...
  factory ViewersList.fromJson(Map<String, dynamic> json) => ViewersList(
    userId: json["user_id"] == null ? null : StoryReactionModel.fromJson(json["user_id"]),
...
class StoryReactionModel {
  ...
  factory StoryReactionModel.fromJson(Map<String, dynamic> json) => StoryReactionModel(

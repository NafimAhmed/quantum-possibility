...
List<Stories>? stories;
  ...
  factory StoryModelMerge.fromMap(Map<String, dynamic> map) {
    return StoryModelMerge(
      ...
      user_status: map['user_status'] != null ? map['user_status'] as String : null,
      ...
      stories: map['stories'] != null ? List<Stories>.from((map['stories'] as List<int>).map<Stories?>((x) => Stories.fromMap(x as Map<String,dynamic>),),) : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory StoryModelMerge.fromJson(String source) => StoryModelMerge.fromMap(json.decode(source) as Map<String, dynamic>);
 ...
 String? id;
  ...
  factory Stories.fromMap(Map<String, dynamic> map) {
    return Stories(
      ...
      text_color: map['text_color'] != null ? map['text_color'] as String : null,
      ...
      text_position: map['text_position'] != null ? map['text_position'] as String : null,
      text_alignment: map['text_alignment'] != null ? map['text_alignment'] as String : null,
      user_id: map['user_id'] != null ? map['user_id'] as String : null,
      privacy_id: map['privacy_id'] != null ? map['privacy_id'] as String : null,
      ...
      viewers: List<Viewers>.from((map['viewers'] as List<int>).map<Viewers>((x) => Viewers.fromMap(x as Map<String,dynamic>),),),
    );
  }

  String toJson() => json.encode(toMap());

  factory Stories.fromJson(String source) => Stories.fromMap(json.decode(source) as Map<String, dynamic>);

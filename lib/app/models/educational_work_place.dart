...
class EducationalWorkPlace {
  ...
  factory EducationalWorkPlace.fromMap(Map<String, dynamic> map) {
    return EducationalWorkPlace(
      ...
      start_at: map['start_at'] != null ? map['start_at'] as String : null,
      end_at: map['end_at'] != null ? map['end_at'] as String : null,
      department_id:
  ...
  @override
  String toString() {
    return 'EducationalWorkPlace(id: $id, user_id: $user_id, institute_type_id: $institute_type_id, institute_id: $institute_id, start_at: $start_at, end_at: $end_at, department_id: $department_id, designation_id: $designation_id, edu_or_ins: $edu_or_ins, description: $description, status: $status, ip_address: $ip_address, created_by: $created_by, update_by: $update_by, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }

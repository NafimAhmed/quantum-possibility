...
class NotificationModel {
  ...
  NotificationModel copyWith({
    ...
    return NotificationModel(
      ...
      // resource_object: resource_object ?? this.resource_object,
  ...
  factory NotificationModel.fromMap(Map<String, dynamic> map) {
    return NotificationModel(
      ...
      // resource_object: map['resource_object'] != null
      //     ? map['resource_object'] as String
      //     : null,
  ...
  bool operator ==(covariant NotificationModel other) {
    ...
    return other.id == id &&
        ...
        // other.resource_object == resource_object &&

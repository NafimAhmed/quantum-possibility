...
class ProfileModel {
  ...
  ProfileModel({
    ...
    this.v,
    this.lock_profile,
    required this.email_list,
    required this.phone_list,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'educationWorkplaces': educationWorkplaces.map((x) => x.toMap()).toList(),
  ...
  factory ProfileModel.fromMap(Map<String, dynamic> map) {
    return ProfileModel(
      ...
      websites: map['websites'] != null
          ? (map['websites'] as List).map((e) => e.toString()).toList()
          : [],
      user_about:
